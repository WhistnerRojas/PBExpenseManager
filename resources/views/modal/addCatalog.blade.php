        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addCategory">Add Category</h1>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{route('expenses.addCategory')}}">
                        @csrf

                        <div class="md-3 mb-2">
                            
                            <label for="categoryName" class="form-label">Category Name</label>
                            <input type="text" class="form-control" id="categoryName" name="categoryName" maxlength="45">
